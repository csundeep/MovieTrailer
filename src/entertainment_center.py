...
movie1 = Movie("Inception",
               ...
               "q=tbn:ANd9GcRo9vfJCM6dzPkZHIHB"
               "VCtlJnAnew9Ai26kEdrli0-tfmatmciD",
...
movie2 = Movie("Interstellar",
               ...
               "736x/c2/37/75/c23775191e4f24ede76098337a1b3024.jpg",
               "https://www.youtube.com/watch?v=Lm8p5rlrSkY")

# movie object 3
movie3 = Movie("The Dark knight",
               "When the menace known as the Joker wreaks "
               "havoc and chaos on the people of Gotham, the Dark Knight must "
               "come to terms with one of the greatest "
               "psychological tests of his ability to fight injustice",
               "http://host.trivialbeing.org/up/"
               "tdk-apr28-new-poster-posterexclusivoomelete2.jpg",
